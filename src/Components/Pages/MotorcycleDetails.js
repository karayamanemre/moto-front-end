...
const MotorcycleDetails = () => {
  ...
  return (
    <div>
      <TopNav pageTitle={`${motorcycle.name} Details`} />
      <div className="container flex flex-col items-center sm:flex-row justify-around sm:items-start p-4 gap-10 sm:pt-40">
